...
async def check_receiving_cards_temperature(base_script, no_of_receiver_cards, lan_value):
   monitor_message = "receiving_cards_temperature_voltage"
   temperature_per_receiving_card =[]
   temp_valid, temperature, voltage_valid, voltage, monitoring_card = get_receiver_temp_voltage(base_script,no_of_receiver_cards, lan_value)                  
...
def get_receiver_temp_voltage(base_script,receiver_index_value, lan_value):
# ---------------------------------------------------------------------------------------
